...
<head>
  ...
  <title>Coffee Sarongge - Login</title>
...
<h1 class="text-4xl font-bold mt-4 w-full text-center mb-3 text-[#5A3A1A]">Login</h1>
      ...
      <form class="space-y-4" autocomplete="off">
        <!-- Username -->
        <div class="relative">
          <img src="{{ asset('uploads/email1.png') }}" alt="Email Icon" class="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5">
          <input type="text" id="email" name="email" placeholder=" Email " autocomplete="off" value=""
                 class="w-full pl-12 pr-4 py-2 rounded-full ring-2 ring-[#5A3A1A] focus:outline-none
 text-gray-800">
        </div>

        <!-- Password -->
        <div class="relative">
          <img src="{{ asset('uploads/password.png') }}" alt="Password Icon" class="absolute left-4 top-1/4 transform -translate-y-1/2 w-5 h-5">
          <input type="password" id="password-mobile" name="password" placeholder=" Password " autocomplete="new-password" value=""
                 class="w-full pl-12 pr-10 py-2 rounded-full  rounded-full ring-2 ring-[#5A3A1A] focus:outline-none
 text-gray-800">
...
<button class="w-full flex items-center justify-center gap-3 bg-white text-gray-800 font-semibold py-3 rounded-full ring-2 ring-[#5A3A1A] shadow-md hover:bg-gray-100 transition duration-300 active:bg-[#5A3A1A] active:text-white
">
  ...
  <span>Login dengan Google</span>
      ...
      <!-- Footer -->
      <p class="text-center text-[#5A3A1A] text-sm mt-4">
        Don't have an account? <a href="#" class="underline font-semibold text-[#5A3A1A] hover:text-white">Sign Up</a>
...
<button class="w-full flex items-center justify-center gap-3 bg-white text-gray-800 font-semibold py-3 rounded-full ring-2 ring-[#5A3A1A] shadow-md transition duration-300 hover:bg-[#3f2612] hover:text-white">
  ...
  <span>Login dengan Google</span>
    ...
    <p class="text-center text-white text-lg mt-6">
      Don't have an account? <a href="#" class="underline font-semibold text-white hover:text-[#5A3A1A]">Sign Up</a>
    </p>
