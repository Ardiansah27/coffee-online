...
<section class="min-h-screen bg-cover bg-center flex justify-end items-start pt-40 md:pt-52" 
         style="background-image: url('{{ asset('uploads/back.jpg') }}');">
  <div class="text-center md:text-right text-white px-6 sm:px-10 md:mr-24 lg:mr-40 max-w-3xl">

    <!-- Judul -->
    <h1 class="text-5xl sm:text-5xl md:text-7xl lg:text-8xl font-bold leading-tight tracking-widest drop-shadow-lg"
...
<div class="bg-[#4b2e12] text-white flex flex-col justify-center items-center md:w-1/2 px-8 py-12 text-center">
  <h2 class="text-4xl md:text-5xl font-bold mb-3 leading-snug">From Bean<br>to Cup</h2>
  <p class="text-sm text-[#e7d4c0] mb-2">Perjalanan rasa dari kebun ke meja kamu</p>
  <p class="text-sm text-gray-300 mb-6 max-w-md leading-relaxed">
  ...
  <a href="https://kopisarongge.com/" target="_blank" rel="noopener noreferrer"
     class="bg-white text-[#4b2e12] font-semibold px-6 py-3 rounded-full shadow hover:shadow-md hover:bg-[#f0eae4] transition inline-block text-center">
    Explore Now
  </a>
</div>
